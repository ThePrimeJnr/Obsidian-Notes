...
### Public Cloud
Coud resource is owned and hosted by a third party cloud service provider andis deliverd over the internnte to the genreal public
- Cloud resourrces are shared across the internet to the genral public.
- low cost, high reliability and no maitenace required, since they are provided by the thriid party supplying the cloud resources
